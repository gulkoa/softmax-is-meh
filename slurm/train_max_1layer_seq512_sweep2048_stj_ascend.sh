#!/bin/bash
#SBATCH --job-name=nanogpt-max-1layer-seq512-stj-ascend
...
#SBATCH --output=results/nanogpt-max-1layer-seq512-stj-ascend-%j.out
#SBATCH --error=results/nanogpt-max-1layer-seq512-stj-ascend-%j.err
...
python -u nanogpt/train.py \
    ...
    --attn stieltjes --q 4.0 --pos-enc none --seq-len 512 \
