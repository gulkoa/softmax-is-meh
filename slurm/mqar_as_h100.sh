...
#SBATCH --output=/users/PAS2402/alexg/softmax/softmax-is-meh/results/mqar-as-%j.out
#SBATCH --error=/users/PAS2402/alexg/softmax/softmax-is-meh/results/mqar-as-%j.err
