#!/bin/bash
# Top-2 needle: n_embd scan to find softmax-vs-stj crossover point.
...
OUT_DIR="results/top2_1layer_${TAG}_seq${SEQ}_embd${NEMBD}_h${NHEAD}_initfix_ascend"
mkdir -p "${OUT_DIR}"

echo "=== TOP2 embd-scan: ${TAG} n_embd=${NEMBD} n_head=${NHEAD} ==="
