#!/bin/bash
# Template: 1-layer subtle-needle scaling sweep.
...
OUT_DIR="results/subtle_needle_1layer_${TAG}_seq${SEQ}_nope_h100"
mkdir -p "${OUT_DIR}"

echo "=== subtle-needle 1-layer ${TAG} seq=${SEQ} NoPE h100 ==="
nvidia-smi
