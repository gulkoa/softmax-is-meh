#!/bin/bash
#SBATCH --job-name=nanogpt-bsearch-stj-q8-ascend-retrain
...
#SBATCH --output=results/nanogpt-bsearch-stj-q8-ascend-retrain-%j.out
#SBATCH --error=results/nanogpt-bsearch-stj-q8-ascend-retrain-%j.err
