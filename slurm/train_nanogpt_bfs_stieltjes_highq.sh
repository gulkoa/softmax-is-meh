#!/bin/bash
#SBATCH --job-name=nanogpt-bfs-stj-hq
...
#SBATCH --output=results/nanogpt-bfs-stj-hq-%j.out
#SBATCH --error=results/nanogpt-bfs-stj-hq-%j.err
...
for Q in 16.0 32.0 64.0; do
    ...
    mkdir -p "$OUTDIR"
    echo "=== Training bfs with stieltjes q=$Q (PyTorch ref) ==="
