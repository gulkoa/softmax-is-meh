#!/bin/bash
# Max retrieval at n_embd=16 with explicit seed for reproducibility check.
# Replicates embd-scan conditions exactly but adds --seed for 3-seed averaging.
# Env vars: ATTN, Q, SEED
...
echo "=== MAX embd16 multiseed: ${TAG} seed=${SEED} ==="
