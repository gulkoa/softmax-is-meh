#!/bin/bash
#SBATCH --job-name=nanogpt-max-1l-seq512-sweep-stj-q24-h100
...
#SBATCH --mem=36G
#SBATCH --time=2:00:00
#SBATCH --output=results/nanogpt-max-1l-seq512-sweep-stj-q24-h100-%j.out
#SBATCH --error=results/nanogpt-max-1l-seq512-sweep-stj-q24-h100-%j.err
...
TRAIN_SEQ=512
Q=24.0
OUT_DIR="results/max_1layer_stieltjes_q${Q}_seq${TRAIN_SEQ}_nope_h100"
mkdir -p "${OUT_DIR}"

echo "=== max 1-layer stj q=${Q} train-seq=${TRAIN_SEQ} NoPE h100 ==="
nvidia-smi
