#!/bin/bash
#SBATCH --job-name=nanogpt-needle-sweep-stj-q4-ascend
...
#SBATCH --output=results/nanogpt-needle-sweep-stj-q4-ascend-%j.out
#SBATCH --error=results/nanogpt-needle-sweep-stj-q4-ascend-%j.err
