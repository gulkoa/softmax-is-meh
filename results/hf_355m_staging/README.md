...
`stilt.1-355m`: 355M parameters, GPT-2-medium-style (24 layers, ctx
1024, GPT-2 BPE), trained on 15B tokens of a 70/15/15 mix of
FineWeb-Edu, FineMath, and Python code. KV-cached generation, no hard
token bounds.
